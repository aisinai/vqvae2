...
parser.add_argument('--save_path', type=str, default='/home/aisinai/work/VQ-VAE2/20200317/1channel_densenet121')
...
vqvae_path = f'/home/aisinai/work/VQ-VAE2/20200314/vq_vae/{args.dataset}/{args.train_run}/checkpoint/{args.vqvae_file}'
vqvae_pretrain.load_state_dict(torch.load(vqvae_path))

model = Densenet121().cuda() if cuda else Densenet121()
